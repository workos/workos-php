...
readonly class VaultDekReadContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultDekReadContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultDekReadContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultDekReadContextActor::fromArray($data['actor']) : null,
