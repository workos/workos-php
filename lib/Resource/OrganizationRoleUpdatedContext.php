...
readonly class OrganizationRoleUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationRoleUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationRoleUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationRoleUpdatedContextActor::fromArray($data['actor']) : null,
