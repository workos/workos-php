...
readonly class VaultByokKeyVerificationCompletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultByokKeyVerificationCompletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultByokKeyVerificationCompletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultByokKeyVerificationCompletedContextActor::fromArray($data['actor']) : null,
