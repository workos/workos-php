...
readonly class VaultNamesListedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultNamesListedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultNamesListedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultNamesListedContextActor::fromArray($data['actor']) : null,
