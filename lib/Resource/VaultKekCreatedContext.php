...
readonly class VaultKekCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultKekCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultKekCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultKekCreatedContextActor::fromArray($data['actor']) : null,
