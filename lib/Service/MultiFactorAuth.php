...
class MultiFactorAuth
{
     ...
     * @param string|null $smsTemplate A custom template for the SMS message. Use the {{code}} placeholder to include the verification code. Must not contain URLs or domain names.
