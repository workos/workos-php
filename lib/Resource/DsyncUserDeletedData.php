...
/** The event payload. */
readonly class DsyncUserDeletedData implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncUserDeletedDataEmail>|null
         * @deprecated
         */
        ...
        public ?DsyncUserDeletedDataRole $role = null,
        /**
         * All roles assigned to the user.
         * @var array<\WorkOS\Resource\DsyncUserDeletedDataRole>|null
         */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            role: isset($data['role']) ? DsyncUserDeletedDataRole::fromArray($data['role']) : null,
