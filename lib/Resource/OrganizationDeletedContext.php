...
readonly class OrganizationDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationDeletedContextActor::fromArray($data['actor']) : null,
