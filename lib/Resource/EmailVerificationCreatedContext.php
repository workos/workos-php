...
readonly class EmailVerificationCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\EmailVerificationCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?EmailVerificationCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? EmailVerificationCreatedContextActor::fromArray($data['actor']) : null,
