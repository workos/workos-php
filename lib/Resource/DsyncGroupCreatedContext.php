...
readonly class DsyncGroupCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncGroupCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncGroupCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncGroupCreatedContextActor::fromArray($data['actor']) : null,
