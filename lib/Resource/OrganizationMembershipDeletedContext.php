...
readonly class OrganizationMembershipDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationMembershipDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationMembershipDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationMembershipDeletedContextActor::fromArray($data['actor']) : null,
