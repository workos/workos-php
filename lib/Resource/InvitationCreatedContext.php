...
readonly class InvitationCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\InvitationCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?InvitationCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? InvitationCreatedContextActor::fromArray($data['actor']) : null,
