...
readonly class DsyncUserDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncUserDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncUserDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncUserDeletedContextActor::fromArray($data['actor']) : null,
