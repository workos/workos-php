...
readonly class ActionUserRegistrationDeniedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ActionUserRegistrationDeniedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ActionUserRegistrationDeniedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ActionUserRegistrationDeniedContextActor::fromArray($data['actor']) : null,
