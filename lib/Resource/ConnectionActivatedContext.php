...
readonly class ConnectionActivatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ConnectionActivatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ConnectionActivatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ConnectionActivatedContextActor::fromArray($data['actor']) : null,
