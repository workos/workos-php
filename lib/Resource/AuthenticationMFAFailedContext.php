...
readonly class AuthenticationMFAFailedContext implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationMFAFailedContextActor::fromArray($data['actor']) : null,
