...
readonly class PermissionCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\PermissionCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?PermissionCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? PermissionCreatedContextActor::fromArray($data['actor']) : null,
