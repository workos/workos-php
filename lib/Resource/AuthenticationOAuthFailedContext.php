...
readonly class AuthenticationOAuthFailedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationOAuthFailedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationOAuthFailedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationOAuthFailedContextActor::fromArray($data['actor']) : null,
