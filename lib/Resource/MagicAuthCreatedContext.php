...
readonly class MagicAuthCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\MagicAuthCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?MagicAuthCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? MagicAuthCreatedContextActor::fromArray($data['actor']) : null,
