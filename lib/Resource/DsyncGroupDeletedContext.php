...
readonly class DsyncGroupDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncGroupDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncGroupDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncGroupDeletedContextActor::fromArray($data['actor']) : null,
