...
readonly class DsyncActivatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncActivatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncActivatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncActivatedContextActor::fromArray($data['actor']) : null,
