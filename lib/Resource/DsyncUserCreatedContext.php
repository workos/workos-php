...
readonly class DsyncUserCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncUserCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncUserCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncUserCreatedContextActor::fromArray($data['actor']) : null,
