...
readonly class ConnectionDeactivatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ConnectionDeactivatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ConnectionDeactivatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ConnectionDeactivatedContextActor::fromArray($data['actor']) : null,
