...
readonly class VaultDataUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultDataUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultDataUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultDataUpdatedContextActor::fromArray($data['actor']) : null,
