...
readonly class ConnectionDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ConnectionDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ConnectionDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ConnectionDeletedContextActor::fromArray($data['actor']) : null,
