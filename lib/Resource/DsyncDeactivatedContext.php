...
readonly class DsyncDeactivatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncDeactivatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncDeactivatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncDeactivatedContextActor::fromArray($data['actor']) : null,
