...
readonly class SessionCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\SessionCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?SessionCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? SessionCreatedContextActor::fromArray($data['actor']) : null,
