...
readonly class OrganizationDomainCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationDomainCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationDomainCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationDomainCreatedContextActor::fromArray($data['actor']) : null,
