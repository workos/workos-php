...
readonly class OrganizationDomainUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationDomainUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationDomainUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationDomainUpdatedContextActor::fromArray($data['actor']) : null,
