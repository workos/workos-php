...
class SessionManager
{
     ...
     * enforces an algorithm allow-list, requires a numeric, unexpired exp
     * claim, and — when `$issuer` is given — requires the `iss` claim to match
     * one of the accepted issuers. This is the only path used by
     * {@see authenticate()}; callers must not bypass it.
     *
