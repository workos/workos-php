...
readonly class PermissionDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\PermissionDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?PermissionDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? PermissionDeletedContextActor::fromArray($data['actor']) : null,
