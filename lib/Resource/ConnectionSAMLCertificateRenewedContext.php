...
readonly class ConnectionSAMLCertificateRenewedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ConnectionSAMLCertificateRenewedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ConnectionSAMLCertificateRenewedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ConnectionSAMLCertificateRenewedContextActor::fromArray($data['actor']) : null,
