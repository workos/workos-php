...
readonly class RoleCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\RoleCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?RoleCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? RoleCreatedContextActor::fromArray($data['actor']) : null,
