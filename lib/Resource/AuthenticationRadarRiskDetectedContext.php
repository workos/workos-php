...
readonly class AuthenticationRadarRiskDetectedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationRadarRiskDetectedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationRadarRiskDetectedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationRadarRiskDetectedContextActor::fromArray($data['actor']) : null,
