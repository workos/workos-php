...
readonly class DsyncDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncDeletedContextActor::fromArray($data['actor']) : null,
