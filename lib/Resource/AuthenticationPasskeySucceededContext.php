...
readonly class AuthenticationPasskeySucceededContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationPasskeySucceededContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationPasskeySucceededContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationPasskeySucceededContextActor::fromArray($data['actor']) : null,
