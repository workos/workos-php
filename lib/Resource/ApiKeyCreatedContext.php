...
readonly class ApiKeyCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ApiKeyCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ApiKeyCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ApiKeyCreatedContextActor::fromArray($data['actor']) : null,
