...
readonly class InvitationRevokedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\InvitationRevokedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?InvitationRevokedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? InvitationRevokedContextActor::fromArray($data['actor']) : null,
