...
readonly class VaultDataCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultDataCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultDataCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultDataCreatedContextActor::fromArray($data['actor']) : null,
