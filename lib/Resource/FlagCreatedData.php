...
/** The event payload. */
readonly class FlagCreatedData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?FlagCreatedDataOwner $owner,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            owner: isset($data['owner']) ? FlagCreatedDataOwner::fromArray($data['owner']) : null,
            tags: $data['tags'],
