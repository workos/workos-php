...
readonly class VaultMetadataReadContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultMetadataReadContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultMetadataReadContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultMetadataReadContextActor::fromArray($data['actor']) : null,
