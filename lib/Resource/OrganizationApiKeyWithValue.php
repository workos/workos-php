...
readonly class OrganizationApiKeyWithValue implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public OrganizationApiKeyWithValueOwner $owner,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            id: $data['id'],
            owner: OrganizationApiKeyWithValueOwner::fromArray($data['owner']),
            name: $data['name'],
