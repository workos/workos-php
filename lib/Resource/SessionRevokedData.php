...
/** The event payload. */
readonly class SessionRevokedData implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?SessionRevokedDataImpersonator $impersonator = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            impersonator: isset($data['impersonator']) ? SessionRevokedDataImpersonator::fromArray($data['impersonator']) : null,
