...
/** The event payload. */
readonly class DsyncUserCreatedData implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncUserCreatedDataEmail>|null
         * @deprecated
         */
        ...
        public ?DsyncUserCreatedDataRole $role = null,
        /**
         * All roles assigned to the user.
         * @var array<\WorkOS\Resource\DsyncUserCreatedDataRole>|null
         */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            role: isset($data['role']) ? DsyncUserCreatedDataRole::fromArray($data['role']) : null,
