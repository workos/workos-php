...
readonly class UserUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\UserUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?UserUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? UserUpdatedContextActor::fromArray($data['actor']) : null,
