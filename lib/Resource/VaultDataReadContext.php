...
readonly class VaultDataReadContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultDataReadContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultDataReadContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultDataReadContextActor::fromArray($data['actor']) : null,
