...
readonly class AuthenticationPasswordSucceededContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationPasswordSucceededContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationPasswordSucceededContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationPasswordSucceededContextActor::fromArray($data['actor']) : null,
