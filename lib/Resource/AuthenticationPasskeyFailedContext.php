...
readonly class AuthenticationPasskeyFailedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationPasskeyFailedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationPasskeyFailedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationPasskeyFailedContextActor::fromArray($data['actor']) : null,
