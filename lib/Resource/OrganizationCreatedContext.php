...
readonly class OrganizationCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationCreatedContextActor::fromArray($data['actor']) : null,
