...
readonly class PasswordResetCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\PasswordResetCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?PasswordResetCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? PasswordResetCreatedContextActor::fromArray($data['actor']) : null,
