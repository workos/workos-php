...
readonly class AuthenticationSSOSucceededContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationSSOSucceededContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationSSOSucceededContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationSSOSucceededContextActor::fromArray($data['actor']) : null,
