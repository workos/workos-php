...
readonly class OrganizationDomainVerifiedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationDomainVerifiedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationDomainVerifiedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationDomainVerifiedContextActor::fromArray($data['actor']) : null,
