...
readonly class UserDeletedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\UserDeletedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?UserDeletedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? UserDeletedContextActor::fromArray($data['actor']) : null,
