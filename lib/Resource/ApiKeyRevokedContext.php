...
readonly class ApiKeyRevokedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\ApiKeyRevokedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?ApiKeyRevokedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? ApiKeyRevokedContextActor::fromArray($data['actor']) : null,
