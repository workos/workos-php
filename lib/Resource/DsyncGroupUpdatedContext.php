...
readonly class DsyncGroupUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncGroupUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncGroupUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncGroupUpdatedContextActor::fromArray($data['actor']) : null,
