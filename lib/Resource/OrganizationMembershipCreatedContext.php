...
readonly class OrganizationMembershipCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationMembershipCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationMembershipCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationMembershipCreatedContextActor::fromArray($data['actor']) : null,
