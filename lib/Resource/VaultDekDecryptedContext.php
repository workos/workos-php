...
readonly class VaultDekDecryptedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\VaultDekDecryptedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?VaultDekDecryptedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? VaultDekDecryptedContextActor::fromArray($data['actor']) : null,
