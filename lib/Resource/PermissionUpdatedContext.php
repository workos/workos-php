...
readonly class PermissionUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\PermissionUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?PermissionUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? PermissionUpdatedContextActor::fromArray($data['actor']) : null,
