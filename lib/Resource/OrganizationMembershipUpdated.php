...
readonly class OrganizationMembershipUpdated implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $event,
        /** The event payload. */
        public OrganizationMembershipUpdatedData $data,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            id: $data['id'],
            event: $data['event'] ?? 'organization_membership.updated',
