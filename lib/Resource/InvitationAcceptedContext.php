...
readonly class InvitationAcceptedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\InvitationAcceptedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?InvitationAcceptedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? InvitationAcceptedContextActor::fromArray($data['actor']) : null,
