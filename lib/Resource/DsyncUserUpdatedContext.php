...
readonly class DsyncUserUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\DsyncUserUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?DsyncUserUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? DsyncUserUpdatedContextActor::fromArray($data['actor']) : null,
