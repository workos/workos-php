...
readonly class OrganizationRoleCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationRoleCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationRoleCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationRoleCreatedContextActor::fromArray($data['actor']) : null,
