...
readonly class AuthenticationMagicAuthSucceeded implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public ?AuthenticationMagicAuthSucceededContext $context = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            object: $data['object'],
            context: isset($data['context']) ? AuthenticationMagicAuthSucceededContext::fromArray($data['context']) : null,
        );
    }
