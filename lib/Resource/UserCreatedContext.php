...
readonly class UserCreatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\UserCreatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?UserCreatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? UserCreatedContextActor::fromArray($data['actor']) : null,
