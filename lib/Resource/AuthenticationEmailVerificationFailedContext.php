...
readonly class AuthenticationEmailVerificationFailedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationEmailVerificationFailedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationEmailVerificationFailedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationEmailVerificationFailedContextActor::fromArray($data['actor']) : null,
