...
/** The event payload. */
readonly class OrganizationCreatedData implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationCreatedDataDomain>
         */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            id: $data['id'],
            name: $data['name'],
            domains: array_map(fn ($item) => OrganizationCreatedDataDomain::fromArray($item), $data['domains']),
