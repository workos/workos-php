...
readonly class OrganizationDomainVerificationFailed implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $event,
        /** The event payload. */
        public OrganizationDomainVerificationFailedData $data,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            id: $data['id'],
            event: $data['event'] ?? 'organization_domain.verification_failed',
