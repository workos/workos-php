...
readonly class RoleUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\RoleUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?RoleUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? RoleUpdatedContextActor::fromArray($data['actor']) : null,
