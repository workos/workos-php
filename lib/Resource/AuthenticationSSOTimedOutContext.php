...
readonly class AuthenticationSSOTimedOutContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\AuthenticationSSOTimedOutContextGoogleAnalyticsSession>|null
         */
        ...
        public ?AuthenticationSSOTimedOutContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? AuthenticationSSOTimedOutContextActor::fromArray($data['actor']) : null,
