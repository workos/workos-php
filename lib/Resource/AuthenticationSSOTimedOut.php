...
readonly class AuthenticationSSOTimedOut implements \JsonSerializable
{
    ...
    public function __construct(
        ...
        public string $event,
        /** The event payload. */
        public AuthenticationSSOTimedOutData $data,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            id: $data['id'],
            event: $data['event'] ?? 'authentication.sso_timed_out',
