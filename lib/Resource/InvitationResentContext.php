...
readonly class InvitationResentContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\InvitationResentContextGoogleAnalyticsSession>|null
         */
        ...
        public ?InvitationResentContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? InvitationResentContextActor::fromArray($data['actor']) : null,
