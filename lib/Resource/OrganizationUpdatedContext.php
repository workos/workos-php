...
readonly class OrganizationUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationUpdatedContextActor::fromArray($data['actor']) : null,
