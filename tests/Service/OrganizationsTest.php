...
class OrganizationsTest extends TestCase
{
    ...
    public function testListOrganizations(): void
    {
        ...
        $result = $client->organizations()->listOrganizations(before: 'test_value', after: 'test_value', limit: 1, order: \WorkOS\Resource\PaginationOrder::Normal, domains: [], search: 'test_value');
