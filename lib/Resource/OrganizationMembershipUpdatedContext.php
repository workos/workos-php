...
readonly class OrganizationMembershipUpdatedContext implements \JsonSerializable
{
    ...
    public function __construct(
         ...
         * @var array<\WorkOS\Resource\OrganizationMembershipUpdatedContextGoogleAnalyticsSession>|null
         */
        ...
        public ?OrganizationMembershipUpdatedContextActor $actor = null,
        /**
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            actor: isset($data['actor']) ? OrganizationMembershipUpdatedContextActor::fromArray($data['actor']) : null,
